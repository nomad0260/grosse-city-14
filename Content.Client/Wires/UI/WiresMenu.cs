...
namespace Content.Client.Wires.UI
{
    public sealed partial class WiresMenu : BaseWindow
    {
        ...
        public WiresMenu()
        {
            ...
            var font = _resourceCache.GetStack("Regular", 13);
            var fontSmall = _resourceCache.GetStack("Regular", 10);
        ...
        private sealed class WireControl : Control
        {
                ...
                IResourceCache resourceCache)
            {
                ...
                var greek = new Label
                {
                    ...
                    FontOverride = _resourceCache.GetStack("Bold", 12),
                    FontColorOverride = Color.Gray,
                    ToolTip = letter.Name(),
                    MouseFilter = MouseFilterMode.Stop
                };
        ...
        private sealed class StatusLight : Control
        {
            ...
            public StatusLight(StatusLightData data, IResourceCache resourceCache)
            {
                ...
                var font = resourceCache.GetStack("Bold", 12);
