...
public sealed partial class LoadingScreenControl : Control
{
    ...
    public LoadingScreenControl(IResourceCache resCache)
    {
        ...
        // Honour the selectable UI font style on the loading screen too.
        var fonts = IoCManager.Resolve<IUiFontStackManager>();
        Header.FontOverride = fonts.GetChatStack(resCache, "Bold", 24, display: true);
        Subtext.FontOverride = fonts.GetChatStack(resCache, "Bold", 12, display: true);
