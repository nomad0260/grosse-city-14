...
control-lobby-header = Контроль
control-lobby-need-loadout = Выберите команду и класс или нажмите «Рандом», затем Ready.
control-lobby-team-full = Эта команда переполнена. Выберите другую или «Рандом».
control-lobby-class-full = Этот класс уже занят. Выберите другой.
control-lobby-queued = Вы в очереди волны. Ждите респауна.

control-point-default = Точка
control-capture-unnamed = Точка
control-capture-examined = { $name }: нейтральна, захват { $percent }%
control-capture-examined-owned = { $name }: { $owner }, захват { $percent }%
control-gate-tools-blocked = Этот затвор заблокирован на время подготовки.

control-hud-phase-prep = Подготовка: { $time }
...
control-announce-fight = Бой начался! Захватывайте и удерживайте консоли.
control-announce-comeback = Команда { $name } отстаёт. На их базе появился ящик со снаряжением.
control-announce-retreat = { $winner } победили по очкам. { $loser } отступают! У вас { $time } с, чтобы добраться до базы.
