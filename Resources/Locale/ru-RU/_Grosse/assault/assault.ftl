assault-preset-title = Штурм
assault-preset-description = Атакующие захватывают зоны подряд. Волны, очки возрождения, затворы между зонами.
...
assault-lobby-select-team = Команда
assault-lobby-select-class = Класс
...
assault-class-rebel-rifle = Повстанец
assault-class-rebel-rifle-desc = Винтовка, базовая экипировка.
assault-class-rebel-shotgun = Повстанец (дробовик)
assault-class-rebel-shotgun-desc = Дробовик ближнего боя.
assault-class-rebel-ar2 = Повстанец (AR2)
assault-class-rebel-ar2-desc = Тяжёлая импульсная винтовка.
assault-class-cp = Гражданская Оборона
assault-class-cp-desc = Пистолет и снаряжение ГО.
assault-class-cp-smg = ГО (ПП)
assault-class-cp-smg-desc = Пистолет-пулемёт.
assault-class-ota = OTA
assault-class-ota-desc = Солдат транстического Альянса.
assault-class-ota-elite = OTA Elite
assault-class-ota-elite-desc = Элитная броня и AR2.

assault-hud-phase-prep = Подготовка: { $time }
...
assault-class-select-title = Выбор класса
assault-class-select-tickets = Очки возрождения: { $tickets }
