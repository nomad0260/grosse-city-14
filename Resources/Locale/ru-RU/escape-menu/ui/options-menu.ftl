...
ui-options-font-style = Стиль шрифта:
ui-options-font-style-default = По умолчанию
ui-options-font-style-epilepsy-sans = Epilepsy Sans
ui-options-font-style-cozette = Cozette
ui-options-font-style-bedstead = Bedstead
ui-options-font-style-pixeloid = Pixeloid
