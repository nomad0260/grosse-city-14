...
public sealed partial class GrosseInitializeZNetworkCommand : LocalizedEntityCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        {
            shell.WriteError($"Target entity doesnt have GrosseZLevelsNetworkComponent {args[1]}");
            return;
        }
