...
public sealed partial class GrosseZPhysicsComponent : Component
{
    /// <summary>
    ...
    /// <summary>
    /// If true, GrosseGetZVelocityEvent is raised every physics tick so systems (e.g. flight) can adjust Velocity.
