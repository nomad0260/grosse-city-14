...
namespace Content.Shared._Grosse.ZLevels.Damage;

public sealed partial class GrosseZLevelDamageSystem : EntitySystem
{
    ...
    private static readonly EntProtoId FallVFX = "GrosseDustEffect";

    public override void Initialize()
    {
        base.Initialize();
        SubscribeLocalEvent<PhysicsComponent, GrosseZLevelHitEvent>(OnFallDamage);

        _config.OnValueChanged(CCVars.GrosseBaseFallingDamage, i => BaseFallingDamage = i, true);
        _config.OnValueChanged(CCVars.GrosseBaseFallingOtherDamage, i => BaseFallingOtherDamage = i, true);
        _config.OnValueChanged(CCVars.GrosseBaseFallingStunTime, i => BaseFallingStunTime = i, true);
        _config.OnValueChanged(CCVars.GrosseBaseFallingOtherStunTime, i => BaseFallingOtherStunTime = i, true);
    }
    private void OnFallDamage(Entity<PhysicsComponent> ent, ref GrosseZLevelHitEvent args)
    {
        ...
        var damageToOtherEv = new GrosseZFallingOnTargetDamageCalculateEvent(args.ImpactPower);
        ...
        var damageToSelfEv = new GrosseZFallingDamageCalculateEvent(ent, args.ImpactPower);
        ...
        var imFallOnEv = new GrosseZImFallOnEvent(entitiesAround, args.ImpactPower);
        ...
        foreach (var victim in entitiesAround)
        {
            ...
            var editDamageToSelfEv = new GrosseZFallingDamageCalculateEvent(ent, args.ImpactPower);
            ...
            var fellOnMeEv = new GrosseZFellOnMeEvent(ent, args.ImpactPower);
...
/// </summary>
public sealed partial class GrosseZFallingDamageCalculateEvent(EntityUid fallen, float speed) : EntityEventArgs
{
...
/// </summary>
public sealed partial class GrosseZFallingOnTargetDamageCalculateEvent(float speed) : EntityEventArgs
{
    public float DamageMultiplier = 1;
    public float StunMultiplier = 1;
    public float Speed = speed;
...
/// </summary>
public sealed partial class GrosseZImFallOnEvent(HashSet<EntityUid> targets, float speed) : EntityEventArgs
{
...
/// </summary>
public sealed partial class GrosseZFellOnMeEvent(EntityUid fallen, float speed) : EntityEventArgs
{
    public EntityUid Fallen = fallen;
    public float Speed = speed;
}
