...
public sealed class AllGamePresetsStartTest : AntagTest
{
    ...
    /// </summary>
    private static readonly HashSet<string> IgnoredPresets = ["City14Assault", "City14Control"]; // Arena PvP: no NT station/centcomm. Covered by AssaultMapTest / ControlMapTest.
